...
<a href="https://en.wikipedia.org/wiki/Goodhart%27s_law">Gotthard's Law:</a> "When a measure becomes a target, it ceases to be a good measure"

## Glossary

* **Bug** Unintended side effect
* **Debt** Work to be done (Poor planning?)
* **Defect** Result that doesn't meet expectation
* **Error** Mistake in code
* **Failure**
* **Fault**
* **Incident** Something to look
* **Issue**
* **Problem**
* **Risk** Something to be aware of
* **Threat**
* **Warning** When you are warned?
